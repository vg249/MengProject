...
#define GRAYLEVEL       255 /* No. of gray levels */
...
/* for image1[ ][ ]Cx_size1Cy_size1 */
{
  ...
  /* Input of image data*/ //Changed on 4/18/2016
  for (y = 0; y < y_size1+2; y++) {
    for (x = 0; x < x_size1+2; x++) {
      if (x == 0 || y == 0 || x == (x_size1-1) || y == (y_size1-1)) { 
        image1[y][x] = 0;}
      else{
